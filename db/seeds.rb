...
IMAGES = ["home1.jpg", "home2.jpg", "home3.jpg", "home4.png", "home5.jpg", "home6.jpg", "home7.jpg"  ]

h1 = Home.create({title: "A Real Scream", lat: 40.751265, lng: -73.983979, price: 50, occupancy: 6, beds: 4, baths: 1, host_id: u0.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://www.auction.com/blog/wp-content/uploads/2015/10/fear-of-home-buying.jpg", description: DESCRIPTIONS.sample})
h2 = Home.create({title: "Your Nightmare", lat: 40.789980, lng: -73.941654, price: 20, occupancy: 4, beds: 3, baths: 1, host_id: u0.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://www.lovethispic.com/uploaded_images/40535-Scary-Blue-Haunted-House.jpg", description: DESCRIPTIONS.sample})
h3 = Home.create({title: "Alive House", lat: 40.728667, lng: -73.987426, price: 47, occupancy: 4, beds: 4, baths: 1, host_id: u0.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://www.thefix.com/sites/default/files/styles/article/public/scaryhouse.jpg", description: DESCRIPTIONS.sample})
h4 = Home.create({title: "Nothing To See Here", lat: 40.729943, lng: -73.981064, price: 89, occupancy: 3, beds: 2, baths: 1, host_id: u1.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://img1.etsystatic.com/126/0/11598164/il_570xN.1035544531_4wma.jpg", description: DESCRIPTIONS.sample})
h5 = Home.create({title: "Witch Hangout", lat: 40.751264, lng: -73.983400, price: 20, occupancy: 8, beds: 6, baths: 1, host_id: u2.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://photos.smugmug.com/Portfolio/i-9wVzbS8/0/44b1346a/X2/trey-ratcliff-long-scary-room-X2.jpg", description: DESCRIPTIONS.sample})
h6 = Home.create({title: "Addams Family Mansion", lat: 40.741232, lng: -73.973934, price: 15, occupancy: 2, beds: 1, baths: 1, host_id: u3.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "https://www.remotelands.com/remotenew1/dist/images/hotel/preferhotel/s160826001.jpg", description: DESCRIPTIONS.sample})
h7 = Home.create({title: "Room 23", lat: 40.711222, lng: -73.983979, price: 60, occupancy: 4, beds: 4, baths: 1, host_id: u4.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://i0.wp.com/danniebspeaks.com/wp-content/uploads/2016/10/Mooneys-mansion.jpg?resize=375%2C250", description: DESCRIPTIONS.sample})
h8 = Home.create({title: "Transylvania Getaway", lat: 46.173971, lng: 25.233201, price: 60, occupancy: 4, beds: 4, baths: 1, host_id: u4.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://www.remotelands.com/remotenew1/dist/images/hotel/preferhotel/s160826001.jpg", description: DESCRIPTIONS.sample})
h9 = Home.create({title: "Zimbabwe gets creepy!", lat: -18.995532, lng: 29.146541, price: 120, occupancy: 7, beds: 5, baths: 2, host_id: u15.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://www.lovethispic.com/uploaded_images/40535-Scary-Blue-Haunted-House.jpg", description: DESCRIPTIONS.sample})
h10 = Home.create({title: "San Francisco Rules!", lat: 37.765081, lng: -122.461004, price: 350, occupancy: 2, beds: 1, baths: 1, host_id: u14.id, image: File.open("app/assets/images/" + IMAGES.sample), image_url: "http://i.dailymail.co.uk/i/pix/2014/01/24/article-2545200-1AEBCA2C00000578-936_964x641.jpg", description: "If you HAVE to leave New York for your scares, this place does the job."})
...
100.times do
  Home.create({title: randomHomeTitle, lat: rand(40.704440...40.878000), lng: rand(-74.0100000...-73.914000), price: rand(30...500), occupancy: rand(1...20), beds: rand(1...8), baths: rand(1...4), host_id: randomUserId, image: File.open("app/assets/images/" + IMAGES.sample), description: DESCRIPTIONS.sample })
end
